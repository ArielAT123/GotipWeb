...
const BusinessDashboard: React.FC = () => {
  return (
    <div className="min-h-screen">
      ...
      <div className={`${styles.businessContainer} max-w-7xl mx-auto px-6 py-6 flex flex-col md:flex-row gap-6`}>
        <BusinessSidebar />
        ...
        <main className="business-content flex-1">
          <Card className={`${styles.fadeIn} mb-6`}>
            <div className="card-header flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-5">
              ...
              <Button variant="primary" icon="pencil-alt">
                Editar negocio
              </Button>
            </div>
            <p className="mb-5">Aquí puedes gestionar todos los aspectos de tu negocio. Revisa tus estadísticas, productos y conexiones con clientes.</p>
            <BusinessStats />
          </Card>
